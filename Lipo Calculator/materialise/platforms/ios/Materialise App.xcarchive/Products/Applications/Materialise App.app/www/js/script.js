//Patient Height
var surgeon_experience_less_99;
var height_in;
var weight_pound;
var height_m;
var weight_kg
...
function calculate(){
	...
	FAT_ASPIRATE_LIMIT = Math.round(FAT_ASPIRATE_LIMIT);
	MAINTAINCE_ADDED_IV = Math.round(MAINTAINCE_ADDED_IV);
	Lactated_Ringers_L = Math.round(Lactated_Ringers_L);
	Total_1_Lido_ccs = Math.round(Total_1_Lido_ccs);
	Lido_Max_1_ccs = Math.round(Lido_Max_1_ccs);
	_1_Lido_cc_per_L = Math.round(_1_Lido_cc_per_L);
	_1_1000_Epi_cc_per_L = Math.round(_1_1000_Epi_cc_per_L);
...
function setResultToViews(){
	$('.FAT_ASPIRATE_LIMIT').text("Result: "+localStorage.getItem("FAT_ASPIRATE_LIMIT"));
	$('.MAINTAINCE_ADDED_IV').text("Result: "+localStorage.getItem("MAINTAINCE_ADDED_IV"));
	$('.CHEMOPROPHYLAXIS').text("Result: "+localStorage.getItem("CHEMOPROPHYLAXIS"));
	$('.OVERNIGHT').text("Result: "+localStorage.getItem("OVERNIGHT"));
	$('.Lactated_Ringers_L').text("Result: "+localStorage.getItem("Lactated_Ringers_L"));
	$('.Total_1_Lido_ccs').text("Result: "+localStorage.getItem("Total_1_Lido_ccs"));
	$('.Lido_Max_1_ccs').text("Result: "+localStorage.getItem("Lido_Max_1_ccs"));
	$('._1_Lido_cc_per_L').text("Result: "+localStorage.getItem("_1_Lido_cc_per_L"));
	$('._1_1000_Epi_cc_per_L').text("Result: "+localStorage.getItem("_1_1000_Epi_cc_per_L"));
}

function setResultToExport(){
	$('.FAT_ASPIRATE_LIMIT').text(localStorage.getItem("FAT_ASPIRATE_LIMIT"));
	$('.MAINTAINCE_ADDED_IV').text(localStorage.getItem("MAINTAINCE_ADDED_IV"));
